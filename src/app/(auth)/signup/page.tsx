...
export default function SignupPage() {
            ...
            <div className="min-h-screen flex items-center justify-center px-4">
                <div className="w-full max-w-md liquid-glass p-8 text-center space-y-5 animate-fade-up">
                    ...
                    <button
                        ...
                        className="liquid-btn liquid-btn-primary px-8 py-3"
                    >
                        Go to Login
                    </button>
                </div>
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 relative">
            {/* Background orbs */}
            <div className="absolute top-[-10%] right-[10%] w-[400px] h-[400px] rounded-full bg-violet-300/12 blur-[100px]" />
            <div className="absolute bottom-[-5%] left-[5%] w-[350px] h-[350px] rounded-full bg-teal-300/10 blur-[80px]" />
            ...
            <div className="relative w-full max-w-md liquid-glass p-8 animate-fade-up">
                ...
                <div className="text-center mb-6">
                    ...
                    <p className="text-slate-500 text-sm mt-1">Start your journey to financial barakah</p>
                </div>
                ...
                <p className="text-center text-sm text-slate-400 mt-6">
                    ...
                    <Link href="/login" className="text-indigo-500 hover:text-indigo-600 font-medium transition-colors">
                        Sign In
                    </Link>
                </p>
            </div>
